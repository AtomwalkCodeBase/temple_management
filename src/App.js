...
const Calendar = () => <div style={{padding: '2rem'}}>Calendar Page (Coming Soon)</div>;
const ManualBooking = () => <div style={{padding: '2rem'}}>Manual Booking Page (Coming Soon)</div>;
const Reports = () => <div style={{padding: '2rem'}}>Reports Page (Coming Soon)</div>;
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin/puja-master" element={<PujaMaster />} />
        <Route path="/admin/hall-master" element={<HallMaster />} />
        <Route path="/admin/puja-bookings" element={<PujaBookings />} />
        <Route path="/admin/hall-bookings" element={<HallBookings />} />
