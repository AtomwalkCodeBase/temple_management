...
const ipCommercialRoutes = [
  { path: '/ipCommercial', type: 'ipCommercial', id: 'ipcommercial', content: IpCommercial, theme: themes.patent, component: ServicePage },
];
      ...
      <Router>
        ...
        <Routes>
          ...
          {ipLifecycleRoutes.map(({ path, type, id, content, theme, component: Component }) => (
           ...
           {/* ipCommercial */}
           {ipCommercialRoutes.map(({ path, type, id, content, theme, component: Component }) => (
            <Route
              key={path}
              path={path}
              element={
